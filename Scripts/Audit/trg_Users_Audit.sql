-- Users audit trigger (password hashes redacted). Prefer MASTER_DEPLOY.sql or:
...
BEGIN
    ...
    SELECT
        ...
        CASE
            ...
            ELSE (
                SELECT d.UserId, d.UserName, N'***' AS PasswordHash, d.Email, d.RoleId, d.EmployeeId, d.IsActive, d.CreatedDate, d.ModifiedDate
        ...
        CASE
            ...
            ELSE (
                SELECT i.UserId, i.UserName, N'***' AS PasswordHash, i.Email, i.RoleId, i.EmployeeId, i.IsActive, i.CreatedDate, i.ModifiedDate
                FOR JSON PATH, WITHOUT_ARRAY_WRAPPER
            )
        END,
